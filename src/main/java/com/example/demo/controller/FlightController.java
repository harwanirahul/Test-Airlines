...
import com.example.demo.handler.ControllerExceptionHandler;
...
public class FlightController {
	...
	public ResponseEntity<?> searchFlight(@RequestBody Map<String, String> inputMap) {
	 Flight flight= flightService.getFlightBySourceAndDestinationAndDate(inputMap.get("source"), inputMap.get("destination"), Date.valueOf(inputMap.get("date")));
		if(flight == null)
